        ...
        for condition in self.conditions.conditions_list:
            for resources_key in resources_keys:
                for resource_label, resource_properties in getattr(condition, resources_key).items():
                    ...
                    resources_properties[resource_label][condition.field_name + resources_key] = \
                        resources_properties[resource_label].get(condition.field_name + resources_key, []) + resource_properties
