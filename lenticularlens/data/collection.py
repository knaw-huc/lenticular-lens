...
from lenticularlens.data.timbuctoo import Timbuctoo
from lenticularlens.util.config_db import conn_pool
from lenticularlens.util.hasher import table_name_hash, column_name_hash, hash_string_min
...
class Collection:
    ...
    def determine_prefix_mappings(self):
        ...
        from lenticularlens.util.config_db import fetch_many
