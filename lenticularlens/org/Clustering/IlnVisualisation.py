...
import lenticularlens.org.DataAccess.Middleware as Middleware
...
from lenticularlens.org.Clustering.Iln_eQ import sigmoid
from lenticularlens.org.Generic.Utility import pickle_deserializer, to_nt_format, print_heading, completed, \
    get_uri_local_name_plus, undo_nt_format,  print_object, get_key, hasher, hash_number, problem

import lenticularlens.org.DataAccess.Stardog.Query as Stardog
