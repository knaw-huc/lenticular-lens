...
if __name__ == '__main__':
    ...
    with open(join(dirname(realpath(__file__)), 'test_config.json'), 'r') as config_file:
    ...
    while True:
        ...
        try:
            ...
            if job_status == 'Finished':
                ...
                filename = join(dirname(realpath(__file__)), 'temp_results.nq.gz')
                ...
                if subprocess.run(['md5sum', '-c', 'temp_results.nq.md5'], stdout=subprocess.PIPE).returncode == 0:
