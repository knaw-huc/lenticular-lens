...
import fcntl
import gzip
from common.helpers import update_alignment_job, table_to_csv
...
from common.ll.LLData import RDF_DIR
                        ...
                        if converting_process.returncode == 0:
                            ...
                            for match in linksets_collection.matches:
                                ...
                                if match.is_association:
                                    from common.ll.LLData.CSV_Associations import CSV_ASSOCIATIONS_DIR as CSV_DIR
                                    prefix = 'association'
                                else:
                                    from common.ll.LLData.CSV_Alignments import CSV_ALIGNMENTS_DIR as CSV_DIR
                                    prefix = 'alignment'
