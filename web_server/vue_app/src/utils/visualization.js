...
export function draw(popup, graph_parent, svg_name, svg_name_child) {
    ...
    ////// NEW CODE FOR SHOWING TOOLTIP ON MOUSE-OVER
    ...
    function update(svg_input, json_graph, rest_simulation)
    {
        ...
        link = svg_input.append("g")
            ...
            .on('mouseover.tooltip', function(d) {
                ...
                //"Strength: " + d.strength + "<br>" + "Links: " + d.count)
    ...
    function node_dblclick(d)
    {
        ...
        if (d.child) {
            ...
            //selected_node = d;
            if (this.farthestViewportElement.id == "graph_cluster_parent")
                update(svg, graph_parent, simulation_parent)
            else if (this.farthestViewportElement.id == "graph_cluster_child")
