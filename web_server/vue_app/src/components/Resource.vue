  ...
  <div class="border p-4 mt-4 bg-light" v-bind:class="{'is-invalid': errors.length > 0}">
    <div class="row align-items-center justify-content-between mb-2">
      ...
      <div class="col" v-b-toggle="'resource_' + resource.id">
        <edit-label v-model="resource.label" :required="true"/>
      </div>
        ...
        <div class="row">
          <div class="form-group col-8">
            ...
            <v-select v-model="resource.dataset_id" :id="'dataset_' + resource.id"
              ...
              <option v-for="(data, dataset) in $root.datasets" v-bind:value="dataset">{{ data.title }}</option>
            </v-select>
...
<script>
    import ResourceFilterGroup from "./ResourceFilterGroup";
